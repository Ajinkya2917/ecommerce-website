        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 ">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg font-semibold lg:text-xl text-gray-800">
                {products.product?.brand}
              </h1>
              <h1 className="lg:text-xl text-lg text-gray-900 opacity-60 pt-1">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center">
                  ...
                  <p className="ml-3 opacity-50 text-sm">56500 ratings</p>
                  <p className="ml-3 text-indigo-600 text-sm font-medium\">
                    36500 Reviews
                  </p>
                </div>
              </div>
          ...
          <div className="border rounded-md p-5">
            <div className="flex gap-10">
              ...
              <div className="w-[40%] space-y-4">
                ...
                <p className="opacity-60 text-sm">53,890 ratings</p>
                ...
                <div className="space-y-2 pt-3">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-sm w-24">Excellent</span>
                    <LinearProgress
                      variant="determinate"
                      value={40}
                      color="success"
                  ...
                  {/* Very Good */}
                  <div className="flex items-center gap-3">
                    <span className="text-sm w-24">Very Good</span>
                    <LinearProgress
                      variant="determinate"
                      value={30}
                      color="success"
                  ...
                  {/* Good */}
                  <div className="flex items-center gap-3">
                    <span className="text-sm w-24">Good</span>
                    <LinearProgress
                      variant="determinate"
                      value={15}
                      color="warning"
                  ...
                  {/* Average */}
                  <div className="flex items-center gap-3">
                    <span className="text-sm w-24">Average</span>
                    <LinearProgress
                      variant="determinate"
                      value={10}
                      color="warning"
                  ...
                  {/* Poor */}
                  <div className="flex items-center gap-3">
                    <span className="text-sm w-24">Poor</span>
                    <LinearProgress
                      variant="determinate"
                      value={5}
                      color="error"
