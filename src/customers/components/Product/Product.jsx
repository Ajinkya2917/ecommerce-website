...
//     const existingValue = searchParams.get(sectionId);
...
//                           <MinusIcon
//                             aria-hidden="true"
//                             className="size-5 text-gray-400 hidden group-data-[open]:block"
//                           />
//                         </span>
//                       </DisclosureButton>
//                     </h3>
...
//                     >
//                       <h3 className="-my-3 flow-root">
//                         <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 text-sm">
//                           <span className="font-medium text-gray-900">
//                             {section.name}
//                           </span>
//                           <span className="ml-6 flex items-center">
